...
final class HomeFirstDetailInfoViewCell: UITableViewCell {
    static let reuseIdentifier = "HomeFirstDetailInfoViewCell"
    @IBOutlet weak var iconImage:UIImageView!
    @IBOutlet weak var lblRazonSocial:UILabel!
    @IBOutlet weak var lblCuentaContrato:UILabel!
