...
class PopUpErrorView: BaseAlert {
    ...
    private struct DefaultText {
        ...
        static let descriptionProblem = "Por favor, intenta de nuevo en unos minutos."
        static let titleProblem = "¡Hubo un problema!"
    ...
    func setupView(type: PopUpErrorType) {
        self.type = type
        switch type {
        case .error:
